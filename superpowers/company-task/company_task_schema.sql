...
-- 更新记录:
--   v1.1 - 2026-05-18: 修复4个设计bug
--         1) 去掉task_main.input_source_type = 5
--         2) task_data_temp 增加行级综合处理状态字段
--         3) verify_rules 存储具体rule_code数组，与data_verify_rule表关联
--         4) data_verify_result 增加 third_api_log_id 字段关联第三方API调用日志
-- =============================================
...
COMMENT ON COLUMN task_type_config.default_verify_rules IS '默认验证规则列表(JSON数组，存储data_verify_rule.rule_code)';
...
(1, '基础拉新', '结构化文件批量导入拉新', '["integrity_credit_code","integrity_company_name","integrity_legal_rep","integrity_found_date","integrity_status","integrity_address","compliance_credit_code_format","compliance_company_name_format","compliance_company_name_length","compliance_legal_rep_format","compliance_legal_rep_length","compliance_found_date","compliance_status","duplicate_same_name_diff_company_local","duplicate_same_name_diff_company_nest","duplicate_same_company_diff_name_local","duplicate_same_company_diff_name_nest","authenticity_tianyancha"]', 'system'),
(2, '用户拉新', '用户上传天眼查截图拉新', '["integrity_credit_code","integrity_company_name","integrity_legal_rep","integrity_found_date","integrity_status","integrity_address","compliance_credit_code_format","compliance_company_name_format","compliance_company_name_length","compliance_legal_rep_format","compliance_legal_rep_length","compliance_found_date","compliance_status","duplicate_same_name_diff_company_local","duplicate_same_name_diff_company_nest","duplicate_same_company_diff_name_local","duplicate_same_company_diff_name_nest","authenticity_tianyancha"]', 'system'),
(3, '业务拉新', '业务系统推送企业列表拉新', '["integrity_credit_code","integrity_company_name","integrity_legal_rep","integrity_found_date","integrity_status","integrity_address","compliance_credit_code_format","compliance_company_name_format","compliance_company_name_length","compliance_legal_rep_format","compliance_legal_rep_length","compliance_found_date","compliance_status","duplicate_same_name_diff_company_local","duplicate_same_name_diff_company_nest","duplicate_same_company_diff_name_local","duplicate_same_company_diff_name_nest","authenticity_tianyancha"]', 'system'),
(4, '公司拉新', '企业提交结构化文件拉新', '["integrity_credit_code","integrity_company_name","integrity_legal_rep","integrity_found_date","integrity_status","integrity_address","compliance_credit_code_format","compliance_company_name_format","compliance_company_name_length","compliance_legal_rep_format","compliance_legal_rep_length","compliance_found_date","compliance_status","duplicate_same_name_diff_company_local","duplicate_same_name_diff_company_nest","duplicate_same_company_diff_name_local","duplicate_same_company_diff_name_nest","authenticity_tianyancha"]', 'system');
...
CREATE TABLE IF NOT EXISTS task_main (
    ...
    CONSTRAINT ck_input_source_type CHECK (input_source_type IN (1, 2, 3, 4))
);
...
COMMENT ON COLUMN task_main.input_source_type IS '输入来源类型:1=文件,2=图片,3=压缩包,4=OSS路径';
...
COMMENT ON COLUMN task_main.verify_rules IS '验证规则列表（JSON数组，存储data_verify_rule.rule_code）';
...
CREATE TABLE IF NOT EXISTS task_data_temp (
    ...
    CONSTRAINT ck_row_status CHECK (row_status IN (0, 1, 2, 3, 4, 5, 6, 7, 8))
);
...
COMMENT ON COLUMN task_data_temp.row_status IS '行级综合处理状态:0=待处理,1=解析中,2=解析完成,3=验证中,4=验证通过,5=验证失败,6=入巢中,7=入巢成功,8=入巢失败';
...
CREATE INDEX idx_task_data_temp_row_status ON task_data_temp(row_status);
...
COMMENT ON COLUMN data_verify_result.third_api_log_id IS '关联第三方API调用日志ID（third_api_log.id）';
...
CREATE INDEX idx_data_verify_result_third_api_log_id ON data_verify_result(third_api_log_id);
